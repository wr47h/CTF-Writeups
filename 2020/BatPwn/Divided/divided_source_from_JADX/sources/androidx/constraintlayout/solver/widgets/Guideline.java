...
public class Guideline extends ConstraintWidget {
    ...
    static /* synthetic */ class C01501 {
        ...
        static {
            ...
            try {
                f22x4c44d048[Type.RIGHT.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f22x4c44d048[Type.TOP.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f22x4c44d048[Type.BOTTOM.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f22x4c44d048[Type.BASELINE.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f22x4c44d048[Type.CENTER.ordinal()] = 6;
            } catch (NoSuchFieldError e6) {
            }
            try {
                f22x4c44d048[Type.CENTER_X.ordinal()] = 7;
            } catch (NoSuchFieldError e7) {
            }
            try {
                f22x4c44d048[Type.CENTER_Y.ordinal()] = 8;
            } catch (NoSuchFieldError e8) {
            }
            try {
                f22x4c44d048[Type.NONE.ordinal()] = 9;
    ...
    public ConstraintAnchor getAnchor(Type anchorType) {
        switch (C01501.f22x4c44d048[anchorType.ordinal()]) {
            case 1:
            case 2:
                if (this.mOrientation == 1) {
                    return this.mAnchor;
