...
public abstract class FragmentTransaction {
    ...
    int mExitAnim;
    String mName;
    ArrayList<C0225Op> mOps = new ArrayList<>();
    int mPopEnterAnim;
    int mPopExitAnim;
    ...
    static final class C0225Op {
        ...
        C0225Op(int cmd, Fragment fragment) {
            this.mCmd = cmd;
        ...
        C0225Op(int cmd, Fragment fragment, State state) {
            this.mCmd = cmd;
            this.mFragment = fragment;
    ...
    public void doAddOp(int containerViewId, Fragment fragment, String tag, int opcmd) {
        ...
        addOp(new C0225Op(opcmd, fragment));
    }
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0225Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0225Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0225Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0225Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0225Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C0225Op(8, fragment));
        return this;
    }

    public FragmentTransaction setMaxLifecycle(Fragment fragment, State state) {
        addOp(new C0225Op(10, fragment, state));
        return this;
    }
