    ...
    private static ColorStateList inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (depth < innerDepth && type == 3) {
                ...
                TypedArray a = obtainAttributes(r, theme, attributeSet, C0013R.styleable.ColorStateListItem);
                int baseColor = a.getColor(C0013R.styleable.ColorStateListItem_android_color, -65281);
                float alphaMod = 1.0f;
                if (a.hasValue(C0013R.styleable.ColorStateListItem_android_alpha)) {
                    alphaMod = a.getFloat(C0013R.styleable.ColorStateListItem_android_alpha, 1.0f);
                } else if (a.hasValue(C0013R.styleable.ColorStateListItem_alpha)) {
                    alphaMod = a.getFloat(C0013R.styleable.ColorStateListItem_alpha, 1.0f);
                }
                a.recycle();
                int j = 0;
                ...
                while (i4 < numAttrs) {
                    ...
                    TypedArray a2 = a;
                    if (!(stateResId == 16843173 || stateResId == 16843551 || stateResId == C0013R.attr.alpha)) {
                        int j2 = j + 1;
