    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i3 = 0; i3 < count; i3++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C0220R.C0222id.topPanel) {
                    topPanel = child;
                } else if (id == C0220R.C0222id.buttonPanel) {
                    buttonPanel = child;
                } else if ((id != C0220R.C0222id.contentPanel && id != C0220R.C0222id.customPanel) || middlePanel != null) {
                    return false;
                } else {
                    middlePanel = child;
                }
