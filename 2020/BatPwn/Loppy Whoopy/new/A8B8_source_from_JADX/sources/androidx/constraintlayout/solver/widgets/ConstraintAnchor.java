...
public class ConstraintAnchor {
    ...
    public boolean isValidConnection(ConstraintAnchor anchor) {
        ...
        if (target != type) {
            switch (C00961.f12x4c44d048[this.mType.ordinal()]) {
                case 1:
    ...
    public boolean isSnapCompatibleWith(ConstraintAnchor anchor) {
        ...
        switch (C00961.f12x4c44d048[this.mType.ordinal()]) {
            ...
            case 9:
                return false;
            case 2:
                int i = C00961.f12x4c44d048[anchor.getType().ordinal()];
                if (i == 3 || i == 7) {
                    return true;
                }
                return false;
            case 3:
                int i2 = C00961.f12x4c44d048[anchor.getType().ordinal()];
                if (i2 == 2 || i2 == 7) {
                    return true;
                }
                return false;
            case 4:
                int i3 = C00961.f12x4c44d048[anchor.getType().ordinal()];
                if (i3 == 5 || i3 == 8) {
                    return true;
                }
                return false;
            case 5:
                int i4 = C00961.f12x4c44d048[anchor.getType().ordinal()];
                if (i4 == 4 || i4 == 8) {
                    return true;
                }
                return false;
            case 7:
                int i5 = C00961.f12x4c44d048[anchor.getType().ordinal()];
                if (i5 == 2 || i5 == 3) {
                    return true;
                }
                return false;
            case 8:
                int i6 = C00961.f12x4c44d048[anchor.getType().ordinal()];
                if (i6 == 4 || i6 == 5) {
                    return true;
                }
                return false;
